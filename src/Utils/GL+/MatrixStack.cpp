...
namespace GL {
    ...
    void MatrixStack::loadMatrix(glm::mat4& matrix) {
        _stack.top() = matrix;
    }

    void MatrixStack::multiplyMatrix(glm::mat4& matrix) {
        _stack.top() *= matrix;
    }
    ...
    void MatrixStack::pushMatrix(glm::mat4& matrix) {
        _stack.push(matrix);
    }
    ...
    void MatrixStack::rotate(float angle, glm::vec3& vector) {
    ...
    void MatrixStack::translate(glm::vec3& vector) {
    ...
    void MatrixStack::scale(glm::vec3& vector) {
